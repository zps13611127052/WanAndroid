...
public class Home_Item_Bean {
    ...
    public static class DatasBean {
         ...
         * fresh : true
         * id : 8327
         * link : https://github.com/kaina404/FlutterDouBan
         * niceDate : 10小时前
         * origin :
         * prefix :
         * projectLink :
         * publishTime : 1556499743000
         * superChapterId : 249
         * superChapterName : 干货资源
         * tags : []
         * title : Flutter豆瓣客户端(仿)，诚心开源
         * type : 0
         * userId : -1
         * visible : 1
         * zan : 0
