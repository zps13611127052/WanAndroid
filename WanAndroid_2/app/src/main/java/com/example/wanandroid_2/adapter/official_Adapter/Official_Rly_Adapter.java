...
public class Official_Rly_Adapter extends RecyclerView.Adapter {
    private final FragmentActivity mActivity;
    public final ArrayList<Official_Item_Bean.DataBean.DatasBean> mMlist;

    public Official_Rly_Adapter(FragmentActivity activity, ArrayList<Official_Item_Bean.DataBean.DatasBean> mlist) {
        mActivity = activity;
        mMlist = mlist;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        final viewholder viewholder = (Official_Rly_Adapter.viewholder) holder;
        viewholder.mAuthor.setText(mMlist.get(position).getAuthor());
        viewholder.mPlatform.setText(mMlist.get(position).getChapterName()+"/"+mMlist.get(position).getSuperChapterName());
        viewholder.mPlatform.setTextColor(mActivity.getResources().getColor(R.color.lanse));
    ...
    private void insert(int position, ImageView xin) {
        Official_Item_Bean.DataBean.DatasBean datasBean = mMlist.get(position);
